...
import {deleteTodo, setVisibilityFilter, toggleTodo} from "../actions/actionCreator";
import {SHOW_ACTIVE, SHOW_ALL, SHOW_COMPLETED} from "../actions/actionsTypes";
import {bindActionCreators} from "redux";

class Table extends Component {
    render() {
        return (
            <div className="col-lg-10 offset-1 col-md-10 col-sm-12 col-xs12">
                ...
                {this.props.todos.length !== 0 ? (
                    ...
                    <div
                        ...
                        <div
                            ...
                            Todo List is empty or Filter results no results
                        </div>
                    </div>
                )}
            </div>
